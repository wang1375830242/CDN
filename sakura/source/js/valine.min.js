...
*/
        !function (n, a) {
            ...
            function n(e) {
                ...
                function i() {
                    r();
                    var n = Math.round(parseFloat(e.style.height)), i = window.getComputedStyle(e, null),
                ...
                if (e && e.nodeName && "TEXTAREA" === e.nodeName && !o.has(e)) {
                    var s = null, l = null, c = null, d = function () {
                        e.clientWidth !== l && i()
                    }, u = function (t) {
        ...
        var o = n(9).version, a = n(6), s = n(8), l = n(0), c = n(5), d = n(3), u = n(4), p = n(2), f = n(7),
            h = /^https?\:\/\//,
            v = {comment: "", nick: "Anonymous", mail: "", link: "", ua: navigator.userAgent, url: ""}, g = {
                "zh-cn": {
                    head: {nick: "鏄电О鍠碉紒", mail: "閭鍠碉紒", link: "缃戝潃鍠碉紒(http://)"},
                    tips: {
                        comments: "璇勮",
                        sofa: "蹇潵鍋氱涓€涓瘎璁虹殑浜哄惂~",
                        busy: "杩樺湪鎻愪氦涓紝璇风◢鍊�...",
                        again: "杩欎箞绠€鍗曚篃鑳介敊锛屼篃鏄病璋佷簡."
                    },
                    ctrl: {
                        reply: "鍥炲",
                        ok: "濂界殑",
                    ...
                    error: {
                        99: "鍒濆鍖栧け璐ワ紝璇锋鏌nit涓殑`el`鍏冪礌.",
                        100: "鍒濆鍖栧け璐ワ紝璇锋鏌ヤ綘鐨凙ppId鍜孉ppKey.",
                        401: "鏈粡鎺堟潈鐨勬搷浣滐紝璇锋鏌ヤ綘鐨凙ppId鍜孉ppKey.",
                        403: "璁块棶琚玜pi鍩熷悕鐧藉悕鍗曟嫆缁濓紝璇锋鏌ヤ綘鐨勫畨鍏ㄥ煙鍚嶈缃�."
                    },
                    timeago: {seconds: "绉掑墠", minutes: "鍒嗛挓鍓�", hours: "灏忔椂鍓�", days: "澶╁墠", now: "鍒氬垰"}
                },
                en: {
                ...
                params: "",
                hide: !1
            }, b = ["nick", "mail", "link"], x = Storage && localStorage && localStorage instanceof Storage && localStorage,
            y = location.pathname.replace(/index\.html?$/, "");
        r.prototype.init = function (e) {
            var t = this;
            if (t.config = e, "undefined" == typeof document) return void console;
            "undefined" == typeof AV ? u.dynamicLoadSource("script", {src: "//cdn.jsdelivr.net/npm/leancloud-storage/dist/av-min.js"}, function () {
            ...
            var e = this;
            try {
                var t = e.config, n = t.lang, r = t.langMode, i = t.avatar, a = t.avatarForce, l = t.avatar_cdn,
                    c = t.notify, d = t.verify, p = t.visitor, x = t.pageSize, w = t.recordIP, _ = t.clazzName,
                    A = void 0 === _ ? "Comment" : _;
                e.config.clazzName = A;
                var O = m.ds, S = a ? "&q=" + Math.random().toString(32).substring(2) : "";
                ...
                var M = e.config.app_id || e.config.appId, C = e.config.app_key || e.config.appKey;
                if (!M || !C) throw 99;
                var z = "https://", T = "";
                ...
                var j = e.config.el || null, B = u.findAll(document, j);
                ...
                var I = u.create("div", "class", "vloading"), N = u.find(e.el, ".vlist");
                e.loading = {
                    show: function (t) {
        ...
        var w = function (e, t) {
            ...
            add: function (e) {
                ...
                if (t.length) {
                    var n = t[0], r = u.attr(n, "id"), i = u.attr(n, "data-flag-title"), o = encodeURI(r),
        ...
        r.prototype.Q = function (e) {
            ...
            if (t.el && t.loading.hide().nodata.hide(), "[object Error]" === {}.toString.call(e)) {
                var n = e.code || "", r = t.locale.error[n], i = r || e.message || e.error || "";
            ...
            var t = this, n = u.find(t.el, ".vemojis"), r = u.find(t.el, ".vpreview"), i = u.find(t.el, ".vemoji-btn"),
                o = u.find(t.el, ".vpreview-btn"), f = u.find(t.el, ".veditor"), h = p.data;
            ...
            for (var k = t.config.meta, _ = {}, A = {veditor: "comment"}, O = 0, S = k.length; O < S; O++) A["v" + k[O]] = k[O];
            ...
            var E = function (e, t) {
                ...
                var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1, r = t.config.pageSize,
            ...
            var B = function () {
            ...
            }, P = u.find(t.el, ".vsubmit"), U = function (e) {
                return u.attr(P, "disabled") ? void t.alert.show({
                    type: 0,
                    text: t.locale.tips.busy + '銉�(喙戔暪鈼♀暪)锞�"',
                ...
                var e = AV.Object.extend(t.config.clazzName || "Comment"), n = new e,
                ...
                var r = Math.floor(10 * Math.random() + 1), i = Math.floor(10 * Math.random() + 1),
                    o = Math.floor(10 * Math.random() + 1), a = ["+", "-", "x"], s = a[Math.floor(3 * Math.random())],
                    l = a[Math.floor(3 * Math.random())], c = "" + r + s + i + l + o,
                    d = c + " = <input class='vcode vinput' >";
                t.alert.show({
                    type: 1, text: d, ctxt: t.locale.ctrl.cancel, otxt: t.locale.ctrl.ok, cb: function () {
                        var r = +u.find(t.el, ".vcode").value;
                        new Function("return " + c.replace(/x/g, "*"))() === r ? n && n() : t.alert.show({
                            type: 1,
                            text: "(T锛縏)" + t.locale.tips.again,
                ...
                AV.User.requestPasswordReset(n.mail).then(function (e) {
                    ...
                    1 == r.code ? t.alert.show({
                        type: 0,
                        text: "銉�(锝忥渐蠅锝�)锞� At澶绻佸暒锛屾彁閱掑姛鑳芥殏鏃跺畷鏈恒€�<br>" + r.error,
                        ctxt: t.locale.ctrl.ok
                    }) : F(n).then(function (t) {
                        e(n)
                    }).catch(function (e) {
        ...
        "use strict";
        var r = window, i = document, o = {},
            a = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "`": "&#x60;", "\\": "&#x5c;"};
        for (var s in a) o[a[s]] = s;
        var l = /[&<>"'`\\]/g, c = RegExp(l.source), d = /&(?:amp|lt|gt|quot|#39|#x60|#x5c);/g, u = RegExp(d.source),
            p = {
                domReady: function (e) {
                    ...
                    var r = {script: "src", link: "href"}, o = r[e];
                    ...
                    var n = 0, r = e.length, i = ["[object Array]", "[object NodeList]"], o = {}.toString.call(e);
                    if (i.indexOf(o) > -1) for (; n < r && (!t || !1 !== t.call(e[n], n, e[n])); n++) ; else for (n in e) if (e.hasOwnProperty(n) && t && !1 === t.call(e[n], n, e[n])) break;
                    return e
                }
            };
        e.exports = p
        ...
        var r = function (e, t) {
            if (e) try {
                var n = e.getTime(), r = (new Date).getTime(), o = r - n, a = Math.floor(o / 864e5);
                if (0 === a) {
                    var s = o % 864e5, l = Math.floor(s / 36e5);
                    if (0 === l) {
                        var c = s % 36e5, d = Math.floor(c / 6e4);
                        if (0 === d) {
                            var u = c % 6e4;
        ...
        !function (t, n) {
            ...
            return function (r, i) {
                ...
                var a = 0, s = {},
                    l = /[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|\w+/,
                    c = /</, d = new RegExp("(" + l.source + "|" + c.source + ")|(" + t().source + ")", "gmi");
        ...
        (function (t) {
            !function (t) {
                ...
                g._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g, g._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, g._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, g.autolink = c(g.autolink).replace("scheme", g._scheme).replace("email", g._email).getRegex(), g._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, g.tag = c(g.tag).replace("comment", v._comment).replace("attribute", g._attribute).getRegex(), g._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, g._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f()\\]*\)|[^\s\x00-\x1f()\\])*?)/, g._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, g.link = c(g.link).replace("label", g._label).replace("href", g._href).replace("title", g._title).getRegex(), g.reflink = c(g.reflink).replace("label", g._label).getRegex(), g.normal = p({}, g), g.pedantic = p({}, g.normal, {
                    ...
                    for (var t, n, i, o, a, l = ""; e;) if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length), l += a[1]; else if (a = this.rules.autolink.exec(e)) e = e.substring(a[0].length), "@" === a[2] ? (n = s(this.mangle(a[1])), i = "mailto:" + n) : (n = s(a[1]), i = n), l += this.renderer.link(i, null, n); else if (this.inLink || !(a = this.rules.url.exec(e))) {
        ...
        e.exports = {
            ...
            kissing_heart: "馃槝",
            kissing: "馃槜",
            kissing_smiling_eyes: "馃槞",
            kissing_closed_eyes: "馃槡",
            yum: "馃構",
            stuck_out_tongue_winking_eye: "馃槣",
            stuck_out_tongue_closed_eyes: "馃槤",
            stuck_out_tongue: "馃槢",
            sunglasses: "馃槑",
            smirk: "馃槒",
            unamused: "馃槖",
        ...
        function i(e, t) {
            for (var n = [], r = {}, i = 0; i < e.length; i++) {
                var o = e[i], a = t.base ? o[0] + t.base : o[0], s = o[1], l = o[2], c = o[3],
